...
export const Navbar = ({ children, className }) => {
  ...
  return (
    <motion.div
      ...
      className={twMerge("sticky inset-x-0  w-full fixed", className)}
    >
...
export const NavItems = ({ items, className, onItemClick }) => {
  ...
  return (
    <motion.div
      ...
      className={twMerge(
        "absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-xl  text-zinc-400 transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-2",
        className
      )}
    >
      {items.map((item, idx) => (
